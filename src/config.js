module.exports = {
  ...
  siteKeywords:
    'Prateek Rathore, Prateek, Rathore, androconsis, andro, consis, software engineer, front-end engineer, web developer, javascript, mobile app developer, react-native',
